...
7. Theory is the compression and formalization of observation. Compression = Faster learning. There is nothing "as too theoretical" its my problem to understand it rather than the problem of the theory itself, however, requires correct formalization and rigorous questioning. Pythagorean Theorem, Calculus, Relational Algebra, Turing Machines, Information Theory, were all theories at one point now ubiquitous powering our world and lives and powers every device we own. Our negative perception comes from the connatation and out of context mis-application, the existence of erroroneus use is orthogonal to the structural generalization it offers.
